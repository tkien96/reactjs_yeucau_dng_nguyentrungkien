...
export default function ArticleItemInfo({
  ...
  const createdObject = dayjs(createdDate)
  const dateFromNow = createdObject.fromNow()
  const dateFortmat = createdObject.format(DATE_FORMAT)
    ...
    <div className="article-item__info">
      ...
      <div className="article-item__info-right">
        ...
        <div className="article-item__datetime">
          <div className="date">{dateFortmat}</div> 
          <div className="time">
